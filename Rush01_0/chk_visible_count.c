...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/15 14:19:59 by skamijo           #+#    #+#             */
/*   Updated: 2024/09/15 14:28:35 by skamijo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (chk_row_left(matrix, dim, id, value))
	{
		return (1);
	}
	if (chk_row_right(matrix, dim, id, value))
	{
		return (1);
	}
	if (chk_col_down(matrix, dim, id, value))
	{
		return (1);
	}
	if (chk_col_up(matrix, dim, id, value))
	{
		return (1);
	}
	return (0);
